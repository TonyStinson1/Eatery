...
import Footer from'app/screens/OrderDetail/Component/Footer';
...
const Cart = memo((props: PropsOrderServing) => {
  const {
    boxSize,
    deliveryDate,
    nameReceiver,
        ...
        <View style={styles.nameOrder}>
          <View style={styles.viewNameOrder}>
            ...
            <Text
              style={
                styles.textServing
              }>{`${item.numberServing} serving`}</Text>
          </View>
...
const Header = memo(() => {
  return (
    <>
      <Text style={styles.textBox}>Food Items</Text>
