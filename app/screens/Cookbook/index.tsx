...
const dataMain = [
  {
    name: 'Punjabi',
    svgName: '',
    img: require('../../../images/punjabi.jpeg'),
  },
  { name: 'Thai', svgName: '', img: require('../../../images/Thai-food.jpeg') },
  {
    name: 'Mughlai',
    svgName: '',
    img: require('../../../images/Mughlai-Food.jpeg'),
  },
  { name: 'Chinese', svgName: '', img: require('../../../images/chinese.jpeg') },
  { name: 'Italian', svgName: '', img: require('../../../images/italian.png') },
  { name: 'Mexican', svgName: '', img: require('../../../images/mexican.jpeg') },
  ...
  return (
    <View style={styles.container}>
      <ScrollView
        ...
        style={styles.flex}>
        <Text style={styles.textHeader}>Cuisines</Text>
