...
const RecipeHeaderInfo: React.FC<Props> = memo((props) => {
  const item = data[0];
    ...
    <View style={styles.container}>
      <Swiper
        ...
        <View style={styles.slider}>
          <Image source={props.foodData.img} style={styles.img} />
      ...
      <View style={styles.rate}>
        <Text style={styles.txtName}>{props.foodData.nameOrder || props.foodData.name}</Text>
